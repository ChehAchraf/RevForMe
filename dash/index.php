...
$date_naissance = isset($_POST['date_naissance']) ? mysqli_real_escape_string($conn, $_POST['date_naissance']) : '';

if($nom && $prenom && $email && $telephone && $adresse && $date_naissance) {
    $sql = "INSERT INTO `cliente`(`nom`, `prenom`, `email`, `telephone`, `adresse`, `date_naissance`) 
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="index.html">
                <i class="fa fa-th"></i> <span>Home</span> <small class="label pull-right bg-green">new</small>
              </a>
            </li>
          </ul>
        </section>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <form>
                    ...
                    <div class="mb-3">
                        <label for="places_disponible" class="form-label">Places Disponibles</label>
                        <input type="number" class="form-control" id="places_disponible" required>
                    </div>
                    <button type="submit" class="btn btn-primary">Submit</button>
                </form>
            </div>
